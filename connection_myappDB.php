...
//+ ---------- Database connection, modification and query as PHP-script ----------
...
<!-- You need to have also this file to deny access to security folder "conf" and protect "config.php" containing the
    password and username Nested in : conf / . htaccess : Contains only one line of code : deny from all -->